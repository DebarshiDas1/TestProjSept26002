...
namespace TestProjSept26002.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class TestProjSept26002Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=codezen.database.windows.net;Initial Catalog=T631688_TestProjSept26002;Persist Security Info=True;user id=Lowcodeadmin;password=NtLowCode^123*;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
